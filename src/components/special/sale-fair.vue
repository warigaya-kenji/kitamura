              ...
              <v-hover v-slot="{ hover }">
                <v-expand-transition>
                  <v-card :elevation="hover ? 10 : 2">
                    <a :href="campaign.href" :target="campaign.target === 'blank' ? '_blank' : ''">
                      <v-img :src="campaign.src" max-width="100%" class="hover"></v-img>
                      <span class="item-name text-subtitle-2 including-line-breaks">{{ campaign.productName }}</span>
                    </a>
                  </v-card>
                </v-expand-transition>
              </v-hover>
  ...
  setup: (props, context) => {
    ...
    const state = reactive({
      ...
      campaignlist: [
        ...
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/air-purifier_fair/',
        ...
        {
          category: ['all', 'camera'],
          href: 'https://shop.kitamura.jp/special/sale-fair/camera/waterproof/',
        ...
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/heater-best/',
        ...
        {
          category: ['all', 'camera'],
          href: 'https://shop.kitamura.jp/special/sale-fair/camera/bag/',
        ...
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/ricemill/',
        ...
        {
          category: ['all', 'camera'],
          href: 'https://shop.kitamura.jp/special/sale-fair/general/highly_recommended/2015/0821/',
        ...
        },
        {
          ...
          href: 'https://shop.kitamura.jp/special/sale-fair/sale/shoppingcredit-campaign/',
        ...
        {
          category: ['all', 'sale'],
          href: 'https://shop.kitamura.jp/special/sale-fair/sale/high-magnification/',
        ...
        {
          category: ['all', 'camera'],
          href: 'https://shop.kitamura.jp/special/sale-fair/camera/lensfilter/nikon-arcrest-nd/',
        ...
        {
          category: ['all', 'camera'],
          href: 'https://shop.kitamura.jp/special/sale-fair/camera/printer/',
        ...
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/hairdressing/soie/',
          src: 'https://shop.kitamura.jp/images/banner/2074.jpg',
          productName: 'ボディケア レディースシェーバー特集'
        },
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/fan-fair/',
        ...
        {
          category: ['all', 'kaden'],
          href: 'https://shop.kitamura.jp/special/sale-fair/kaden/fall-of-taste/?display=detail',
