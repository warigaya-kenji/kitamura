<template>
  <v-app>
    <div class="tokutokusueoki-z-lens">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <product-list-by-special-id class="mb-5" :specialId="4535" />
...
export default Vue.extend({
  ...
  setup: () => {
    document.title = 'トクトク据置対象 キヤノン Zレンズ | カメラのキタムラネットショップ';
    document
