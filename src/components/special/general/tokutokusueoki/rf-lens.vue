<template>
  <v-app>
    <div class="tokutokusueoki-rf-lens">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <product-list-by-special-id class="mb-5" :specialId="4534" />
...
export default Vue.extend({
  ...
  setup: () => {
    document.title = 'トクトク据置対象 キヤノン RFレンズ | カメラのキタムラネットショップ';
    document
