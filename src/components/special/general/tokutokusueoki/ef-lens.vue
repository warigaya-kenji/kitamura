<template>
  <v-app>
    <div class="tokutokusueoki-ef-lens">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <product-list-by-special-id class="mb-5" :specialId="4533" />
...
export default Vue.extend({
  ...
  setup: () => {
    document.title = 'トクトク据置対象 キヤノン EFレンズ | カメラのキタムラネットショップ';
    document
      .querySelector<any>('meta[name="description"]')
      .setAttribute(
        'content',
        '【トクトク据置対象 キヤノン RFレンズ】月々のお支払いを圧倒的に安く抑えられる｢トクトク据置｣ 商品の返却時の買取り予定価格を残価額とし、残価額を差し引いた代金を24ヶ月の分割でお支払いできます'
      );
