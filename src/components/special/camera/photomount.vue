  ...
  setup: (props, context) => {
    ...
    const state = reactive({
      ...
      photoMountList: [
        {
          category: ["all", "lpf", ""],
          href: "/special/sale-fair/camera/photomount/269/?display=detail",
          name: 'ハクバ M890',
        ...
        {
          category: ["all", "lpf", ""],
          href: "/special/sale-fair/camera/photomount/266/?display=detail",
          name: 'ハクバ M2730',
        ...
        {
          category: ["all", "lpf", "pf"],
          href: "/special/sale-fair/camera/photomount/254/",
        ...
        {
          category: ["all", "lpf", "pf"],
          href: "/special/sale-fair/camera/photomount/252/",
        ...
        {
          category: ["all", "lpf", "pf"],
          href: "/special/sale-fair/camera/photomount/253/",
        ...
        {
          category: ["all"],
          href: "/special/sale-fair/camera/photomount/2431/",
        ...
        {
          category: ["all"],
          href: "/special/sale-fair/camera/photomount/261/",
        ...
        {
          category: ["all"],
          href: "/special/sale-fair/camera/photomount/2408/",
        ...
        {
          category: ["all", "lpf", "pf"],
          href: "/special/sale-fair/camera/photomount/262/",
        ...
        {
          category: ["all", "lpf"],
          href: "/special/sale-fair/camera/photomount/2430/",
          name: 'チクマ Ｖ67',
        ...
        {
          category: ["all", "lpf"],
          href: "/special/sale-fair/camera/photomount/246/",
          name: 'チクマ No.37',
        ...
        },
        {
          ...
          href: "/special/sale-fair/camera/photomount/245/",
          name: 'チクマ V-216',
        ...
        {
          category: ["all"],
          href: "/special/sale-fair/camera/photomount/2436/",
          name: 'チクマ V-78 写真台紙',
        ...
        {
          category: ["all"],
          href: "/special/sale-fair/camera/photomount/250/",
          name: '友禅写真台紙 V-51',
        ...
        {
          category: ["all", "lpf"],
          href: "/special/sale-fair/camera/photomount/1364/",
        ...
        {
          category: ["all", "lpf", "popularity"],
          href: "/special/sale-fair/camera/photomount/260/",
          name: 'ハクバ 普通台紙 No12',
