  ...
  <v-app>
    <div class="filmcamera-889">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <subText :textItem="'チェキ 価格・商品一覧'" />
        <product-list-by-special-id class="mb-5 mt-5" :specialId="889" />
        <!-- ↓ 相互 -->
...
export default Vue.extend({
  ...
  setup: (props, context) => {
    document.title = '売れ筋人気のチェキ大集合！ | カメラのキタムラネットショップ';
    document
