  ...
  <v-app>
    <div class="filmcamera">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <subText :textItem="'チェキ・チェキフィルム・チェキアルバム おすすめ！商品一覧'" />
        <product-list-by-special-id class="mb-5 mt-5" :specialId="885" />
        <!-- ↓ 相互 -->
...
export default Vue.extend({
  ...
  setup: (props, context) => {
    document.title = 'チェキ・チェキフィルム・チェキアルバム おすすめ！ | カメラのキタムラネットショップ';
    document
