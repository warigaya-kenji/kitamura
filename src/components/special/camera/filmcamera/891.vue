  ...
  <v-app>
    <div class="filmcamera-891">
      <div class="main-contents-wrap">
        ...
        <!-- ↓ 特集IDでの商品一覧表示 -->
        <subText :textItem="'チェキフィルム 価格・商品一覧'" />
        <product-list-by-special-id class="mb-5 mt-5" :specialId="891" />
        <!-- ↓ 相互 -->
...
export default Vue.extend({
  ...
  setup: (props, context) => {
    document.title = 'チェキフィルム | カメラのキタムラネットショップ';
    document
