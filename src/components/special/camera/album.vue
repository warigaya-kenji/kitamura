  ...
  setup: (props, context) => {
    ...
    const state = reactive({
      ...
      albumList: [
        {
          category: ["all", "tai", "po"],
          href: "/ec/special/camera/album/original/1119",
        ...
        {
          category: ["all", "po"],
          href: "/ec/pd/list_dtl.html?index=&searchbox=1&q=オリジナルフォトフォルダー+L・KG・パノラマ判%2F3段&path=",
        ...
        {
          category: ["all", "po", "tai"],
          href: "/ec/pd/list_dtl.html?index=all&searchbox=1&q=ナカバヤシ+TCPK-6L-240&path=&y=0&x=0",
        ...
        {
          category: ["all", "gift", "po", "tai"],
          href: "/ec/special/camera/album/3155",
        ...
        },
        {
          ...
          href: "/ec/special/camera/album/1852",
        ...
        {
          category: ["all", "gift", "fr"],
          href: "/ec/special/camera/album/1855",
        ...
        {
          category: ["all", "gift", "po"],
          href: "/ec/special/camera/album/384",
        ...
        {
          category: ["all", "gift", "fr"],
          href: "/ec/special/camera/album/391",
        ...
        {
          category: ["all", "gift", "fr"],
          href: "/ec/pd/list_dtl.html?index=all&searchbox=1&q=かける～の台紙アルバム+S+ストライプ&path=&y=0&x=0",
        ...
        {
          category: ["all", "po", "tai"],
          href: "/ec/pd/list_dtl.html?index=all&searchbox=1&q=ナカバヤシ+PH6TL-1240&path=&y=0&x=0",
