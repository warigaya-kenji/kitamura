          ...
          <v-row>
            <v-col class="pa-2 float-left" cols="12">
              <v-col cols="12" class="float-left">
                <h2>ペンタックス 人気カメラレンズ一覧</h2>
              </v-col>
              <!-- ↓ 特集IDでの商品一覧表示 -->
              <product-list-by-special-id class="mb-5" :specialId="1648" />
...
export default Vue.extend({
  ...
  props: {},
  setup: (props, context) => {
    document.title = 'ペンタックス 人気カメラレンズ一覧 | カメラのキタムラネットショップ';
    const state = reactive({
      ...
      breadcrumbs: [
        ...
        {
          path: 'ペンタックス 人気カメラレンズ一覧',
          linkUrl: '/ec/special/camera/lens/item-pentax',
          disabled: false
        }
      ],
      // ↑ ---- パンくず情報 ----
