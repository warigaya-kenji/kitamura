          ...
          <v-row>
            <v-col class="pa-2 float-left" cols="12">
              <v-col cols="12" class="float-left">
                <h2>フジフイルム Xマウント 人気カメラレンズ</h2>
              </v-col>
              <!-- ↓ 特集IDでの商品一覧表示 -->
              <product-list-by-special-id class="mb-5" :specialId="3854" />
...
export default Vue.extend({
  ...
  props: {},
  setup: (props, context) => {
    document.title = 'フジフイルム 人気カメラレンズ一覧 | カメラのキタムラネットショップ';
    const state = reactive({
      ...
      breadcrumbs: [
        ...
        {
          path: 'フジフイルム Xマウント 人気レンズ一覧',
          linkUrl: '/ec/special/camera/lens/item-fuji',
          disabled: false
        }
      ],
      // ↑ ---- パンくず情報 ----
