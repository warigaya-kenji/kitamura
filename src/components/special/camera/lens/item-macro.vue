          ...
          <v-row>
            <v-col class="pa-2 float-left" cols="12">
              <v-col cols="12" class="float-left">
                <h2>マクロレンズ おすすめカメラレンズ一覧</h2>
              </v-col>
              <!-- ↓ 特集IDでの商品一覧表示 -->
              <product-list-by-special-id class="mb-5" :specialId="1935" />
...
<script lang="ts">
import Vue from 'vue'; import { reactive, toRefs, onMounted } from '@vue/composition-api';
  ...
  setup: (props, context) => {
    const state = reactive({
      ...
      breadcrumbs: [
        ...
        {
          path: 'マクロレンズ おすすめカメラレンズ一覧',
          linkUrl: '/ec/special/camera/lens/item-macro',
          disabled: false
        }
      ],
      // ↑ ---- パンくず情報 ----
