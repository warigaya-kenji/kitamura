<template>
  <v-app>
    <div class="photomount-254">
      <div class="main-contents-wrap">
        <!-- ↓ パンくず -->
        <breadcrumbs :breadcrumbs="breadcrumbs" />

        <!-- ↓ 特集IDでの商品一覧表示 -->
        <product-list-by-special-id class="mb-5" :specialId="254" />
      </div>
    </div>
  </v-app>
</template>
...
export default Vue.extend({
  ...
  setup: (props, context) => {
    document.title = 'ハクバ MRCDO ランス ドゥシリーズ | カメラのキタムラネットショップ';
    document
