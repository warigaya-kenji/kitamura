<template>
  <v-app>
    <div class="photomount-316">
      <div class="main-contents-wrap">
        <!-- ↓ パンくず -->
        <breadcrumbs :breadcrumbs="breadcrumbs" />

        <!-- ↓ 特集IDでの商品一覧表示 -->
        <product-list-by-special-id class="mb-5" :specialId="316" />
      </div>
    </div>
  </v-app>
</template>
...
export default Vue.extend({
  ...
  setup: (props, context) => {
    document.title = '写真台紙特集 おすすめ！七五三・婚礼・お祝い台紙 | カメラのキタムラネットショップ';
    document
