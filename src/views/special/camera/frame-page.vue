...
export default Vue.extend({
  ...
  setup(props, context) {
    document.title = 'おすすめ 額縁・フォトフレーム | カメラのキタムラネットショップ'
    document.querySelector<any>('meta[name="description"]').setAttribute('content', '全紙や半切サイズにおすすめな額縁や、プレゼントにおすすめなフォトフレームまでカメラのキタムラでは多数ご用意しております！額縁・フォトフレームのご購入はカメラのキタムラネットショップにお任せください。')
