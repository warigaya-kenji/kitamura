...
export default Vue.extend({
  ...
  setup(props, context) {
    document.title = 'おすすめ 写真台紙 | カメラのキタムラネットショップ'
    document.querySelector<any>('meta[name="description"]').setAttribute('content', '2面・3面の写真台紙も、２Ｌサイズの写真台紙も、七五三や結婚式の記念写真を贈るの人気な写真台紙もカメラのキタムラでは多数ご用意しております！写真台紙のご購入はカメラのキタムラネットショップにお任せください。')
